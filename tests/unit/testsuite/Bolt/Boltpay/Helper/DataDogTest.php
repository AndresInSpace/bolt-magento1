...
class Bolt_Boltpay_Helper_DataDogTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var Bolt_Boltpay_Helper_DataDog
     */
    private $datadogHelper;

    public function setUp()
    {
        $this->datadogHelper = Mage::helper('boltpay/DataDog');
    }

    public function testLog()
    {
        $log = $this->datadogHelper->log(self::INFO_MESSAGE);
        $this->assertTrue($log->getLastResponseStatus());
    }
    ...
    public function testLogError()
    {
        ...
        $errorLog = $this->datadogHelper->logError($exception);
